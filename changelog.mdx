...
<Update label="September 22, 2026">
    - Adds `purchaseLimits` to [POST /api/v1/orders/pricing](/endpoints/orders/retrieve-pricing)
</Update>

<Update label="August 21, 2026">
    - Adds ability to retrieve a customer via email or phone to [GET /api/v1/customers/\{identifier\}](/endpoints/customers/retrieve-customer)
</Update>

<Update label="August 19, 2026">
    - Adds `availableDelivery` to [GET /api/v1/payment-types](/endpoints/orders/list-payment-types)
</Update>
