...
<Warning>This endpoint needs to be retrieved using `daffodil.getmeadow.com` or `daffodil-staging.getmeadow.com` instead of the api subdomain. Example URL: `https://daffodil.getmeadow.com/api/v1/products/all`</Warning>
