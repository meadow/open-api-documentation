...
One notable exception to this rule is product and product option `movingAverageCostPerUnit` because they contain more decimal places than 2. These properties will be returned as strings.
